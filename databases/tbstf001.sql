...
INSERT INTO `staffapp_staff` (`userFullName`, `userEmail`, `userPassword`, `userMobile`, `userAge`, `userAddress`, `userCity`, `userState`, `userImage`, `isActive`, `userOtp`, `userOtptime`, `userToken`, `isAvailable`, `isQueue`, `isVerified`, `depttId_id`) VALUES
