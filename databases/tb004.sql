...
-- Dumping data for table hopewelldb.myuserapp_usersignup: ~5 rows (approximately)
...
INSERT INTO `myuserapp_usersignup` (`userFullName`, `userEmail`, `userPassword`, `userMobile`, `userAge`, `userAddress`, `userCity`, `userState`, `isActive`, `roleId_id`, `isVerified`, `userConfirmationlink`, `userOtp`, `userOtptime`, `isAvailable`, `isQueue`, `userToken`) VALUES
	...
	('husduw', 'tusharsaini503@gmail.com', 'pbkdf2_sha256$100000$q4vdn2psnhy2$yVuKvRxd/2ilSKWKXNmtlxjRKIKMm03FrRIOo6bQIU4=', '9518837699', '23', 'SARSWATI GALI V.P.', 'YAMU', 'HARYANA', 1, 1, 1, '', 'V47661I', '2019-10-10 08:26:42.942672', 1, 0, ''),
	('hdff', 'upasnabhat17@gmail.com', 'pbkdf2_sha256$100000$B6ZqpoyWFuy2$WN9Er8XvqVzT9V/mzHavZ9IfReYDL2CZVdwp47w80Ew=', '9518837699', '25', 'SARSWATI GALI V.P..O-MUSTAFABAD', 'YA', 'HARYANA', 1, 1, 0, 'http://127.0.0.1:8000/verifyuser/?email=upasnabhat17@gmail.com&token=J31638F', 'J31638F', '2019-10-09 21:14:45.240649', 1, 0, 'J31638F'),
